---
title: "How to deal with LiDAR data & more"
toc: true
...
knitr::opts_chunk$set(fig.path='{{ site.baseurl }}/assets/images/rmd_images/u04-03/')
library(envimaR)
library(lidR)
...
plot(lidar_file, bg = "white", color = "Z",colorPalette = pal(256))
